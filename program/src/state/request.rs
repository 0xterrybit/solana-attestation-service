...
use super::{
    discriminator::{
        AccountSerialize, 
        AttestationAccountDiscriminators, 
        Discriminator
    },
    SchemaDataTypes,
};
...
pub struct Request {
    ...
    /// Reference to the Schema this Request adheres to
    pub schema: Pubkey,
...
impl Discriminator for Request {
    const DISCRIMINATOR: u8 = AttestationAccountDiscriminators::RequestDiscriminator as u8;
}

impl AccountSerialize for Request {
