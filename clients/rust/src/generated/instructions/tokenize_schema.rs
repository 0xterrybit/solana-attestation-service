...
impl TokenizeSchema {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: TokenizeSchemaInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
