...
impl ChangeSchemaVersion {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: ChangeSchemaVersionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
